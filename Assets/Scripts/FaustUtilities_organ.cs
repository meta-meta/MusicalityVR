...
// @notes organ, {	\"name\": \"organ\",	\"filename\": \"organ.dsp\",	\"version\": \"2.76.0\",	\"compile_options\": \"-lang cpp -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0\",	\"library_list\": [\"/usr/local/share/faust/stdfaust.lib\",\"/usr/local/share/faust/oscillators.lib\",\"/usr/local/share/faust/platform.lib\",\"/usr/local/share/faust/maths.lib\",\"/usr/local/share/faust/basics.lib\"],	\"include_pathnames\": [\"/usr/local/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\".\",\"/root/.\"],	\"size\": 120,	\"inputs\": 0,	\"outputs\": 1,	\"meta\": [ 		{ \"basics.lib/name\": \"Faust Basic Element Library\" },		{ \"basics.lib/tabulateNd\": \"Copyright (C) 2023 Bart Brouns <bart@magnetophon.nl>\" },		{ \"basics.lib/version\": \"1.19.1\" },		{ \"compile_options\": \"-lang cpp -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0\" },		{ \"filename\": \"organ.dsp\" },		{ \"maths.lib/author\": \"GRAME\" },		{ \"maths.lib/copyright\": \"GRAME\" },		{ \"maths.lib/license\": \"LGPL with exception\" },		{ \"maths.lib/name\": \"Faust Math Library\" },		{ \"maths.lib/version\": \"2.8.0\" },		{ \"name\": \"organ\" },		{ \"oscillators.lib/name\": \"Faust Oscillator Library\" },		{ \"oscillators.lib/version\": \"1.5.1\" },		{ \"platform.lib/name\": \"Generic Platform Library\" },		{ \"platform.lib/version\": \"1.3.0\" }	],	\"ui\": [ 		{			\"type\": \"vgroup\",			\"label\": \"organ\",			\"items\": [ 				{					\"type\": \"hslider\",					\"label\": \"freq\",					\"shortname\": \"freq\",					\"address\": \"/organ/freq\",					\"init\": 60,					\"min\": 10,					\"max\": 500,					\"step\": 0.001				},				{					\"type\": \"hslider\",					\"label\": \"gain\",					\"shortname\": \"gain\",					\"address\": \"/organ/gain\",					\"init\": 0.2,					\"min\": 0,					\"max\": 1,					\"step\": 0.001				}			]		}	]}, libFaustPlugin_organ and FaustPlugin_organ are replaced during processing
using System;
using System.Text;
...
namespace FaustUtilities_organ {
    ...
    [CustomEditor(typeof(FaustPlugin_organ))]
    public class FaustPlugin_Editor: Editor {

        // Initialization of the dsp
        private FaustPlugin_organ _dsp;
        ...
        private void OnEnable() {
            fJSON = "{	\"name\": \"organ\",	\"filename\": \"organ.dsp\",	\"version\": \"2.76.0\",	\"compile_options\": \"-lang cpp -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0\",	\"library_list\": [\"/usr/local/share/faust/stdfaust.lib\",\"/usr/local/share/faust/oscillators.lib\",\"/usr/local/share/faust/platform.lib\",\"/usr/local/share/faust/maths.lib\",\"/usr/local/share/faust/basics.lib\"],	\"include_pathnames\": [\"/usr/local/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\".\",\"/root/.\"],	\"size\": 120,	\"inputs\": 0,	\"outputs\": 1,	\"meta\": [ 		{ \"basics.lib/name\": \"Faust Basic Element Library\" },		{ \"basics.lib/tabulateNd\": \"Copyright (C) 2023 Bart Brouns <bart@magnetophon.nl>\" },		{ \"basics.lib/version\": \"1.19.1\" },		{ \"compile_options\": \"-lang cpp -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0\" },		{ \"filename\": \"organ.dsp\" },		{ \"maths.lib/author\": \"GRAME\" },		{ \"maths.lib/copyright\": \"GRAME\" },		{ \"maths.lib/license\": \"LGPL with exception\" },		{ \"maths.lib/name\": \"Faust Math Library\" },		{ \"maths.lib/version\": \"2.8.0\" },		{ \"name\": \"organ\" },		{ \"oscillators.lib/name\": \"Faust Oscillator Library\" },		{ \"oscillators.lib/version\": \"1.5.1\" },		{ \"platform.lib/name\": \"Generic Platform Library\" },		{ \"platform.lib/version\": \"1.3.0\" }	],	\"ui\": [ 		{			\"type\": \"vgroup\",			\"label\": \"organ\",			\"items\": [ 				{					\"type\": \"hslider\",					\"label\": \"freq\",					\"shortname\": \"freq\",					\"address\": \"/organ/freq\",					\"init\": 60,					\"min\": 10,					\"max\": 500,					\"step\": 0.001				},				{					\"type\": \"hslider\",					\"label\": \"gain\",					\"shortname\": \"gain\",					\"address\": \"/organ/gain\",					\"init\": 0.2,					\"min\": 0,					\"max\": 1,					\"step\": 0.001				}			]		}	]}";
            ...
            _dsp = (FaustPlugin_organ) target;          // Sets which component will be edited in the inspector
        }

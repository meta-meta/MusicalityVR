...
{
    /// <summary>
    /// Represents a position where a <see cref="DockableCustom"/> object can be docked.
    /// This component also adds a Collider and a Rigidbody, if they're not already present.
    /// </summary>
    /// <seealso cref="DockableCustom"/>
    /// <seealso cref="MRTK_Custom"/>
    // [AddComponentMenu("Scripts/MRTK/Experimental/Dock/DockPosition")]
    [RequireComponent(typeof(Collider), typeof(Rigidbody))]
    public class DockPositionCustom : MonoBehaviour
    {
        // TODO: IDockPositionData<T> component to carry data for DockableCustom to consume OnDock/Undock 
        public INote Note;
        ...
        private DockableCustom dockedObject = null;

        /// <summary>
        /// The object that is currently docked in this position (can be null).
        /// </summary>
        public DockableCustom DockedObject
        {
            get => dockedObject;

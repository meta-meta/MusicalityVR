...
namespace MRTK_Custom.Dock
{
    ...
    /// </summary>
    /// <seealso cref="Microsoft.MixedReality.Toolkit.Experimental.UI.Dockable"/>
    /// <seealso cref="Microsoft.MixedReality.Toolkit.Experimental.UI.DockPosition"/>
    // [AddComponentMenu("Scripts/MRTK/Experimental/Dock/Dock")]
    public class DockCustom : MonoBehaviour
    {
        /// <summary>
        ...
        private ReadOnlyCollection<DockPositionCustom> dockPositions;

        /// <summary>
        /// A read-only list of possible positions in this dock.
        /// </summary>
        public ReadOnlyCollection<DockPositionCustom> DockPositions => dockPositions;
        ...
        {
            dockPositions = gameObject.GetComponentsInChildren<DockPositionCustom>().ToReadOnlyCollection();
        }
        ...
        public bool TryMoveToFreeSpace(DockPositionCustom position)
        {

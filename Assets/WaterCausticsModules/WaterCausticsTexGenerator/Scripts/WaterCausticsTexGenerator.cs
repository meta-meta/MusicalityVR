...
#pragma warning restore IDE0044
...
#if UNITY_2021_3_OR_NEWER
            kernel = kID.MeshCS;
            cs.SetBuffer (kernel, pID._BufRefract, _bufRefract);
            cs.SetBuffer (kernel, pID._BufMeshRW, _bufMesh);
            cs.SetInt (pID._VertsCnt, _meshVertsCnt);
            cs.Dispatch (kernel, Mathf.CeilToInt ((float) _meshVertsCnt / THREAD_SIZE), 1, 1);
#endif
        ...
        private void drawMesh (RenderTexture rt) {
            ...
            rt.DiscardContents (); // ※←RenderTexture.activeに設定する前に行うこと
            ...
            _cmd.Clear ();
            _cmd.DrawMesh (getMesh (), Matrix4x4.identity, mat, 0, 0);
